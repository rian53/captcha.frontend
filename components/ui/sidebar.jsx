//apps/front/components/ui/sidebar.jsx
		...
		const setOpen = React.useCallback(
			(value) => {
				...
				_setOpen(value);
							...
							// Cookie is now handled by the parent component (SidebarLayout)
		...
		return (
			...
			>
				...
				>
					<div
						data-sidebar="sidebar"
						className="flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow w-full"
					>
						{children}
					</div>
				</div>
